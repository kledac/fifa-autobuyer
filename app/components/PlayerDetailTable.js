				...
				<div className="ut-bio-stats ut-grid-view">
					<div className="ut-bio-stats_item ut-grid-view_item">
    					<div class="ut-bio-stats_header">
      						...
      						<svg className="ut-bio-stats_graph">
        						<rect className="ut-bio-stats_graph-bar ut-bio-stats_graph-bar--good" height="100%" width-percent="74" width="74%"></rect>
      						</svg>
    					</div>
					...
					<div className="ut-bio-stats_item ut-grid-view_item">
    					<div class="ut-bio-stats_header">
      						...
      						<svg className="ut-bio-stats_graph">
        						<rect className="ut-bio-stats_graph-bar ut-bio-stats_graph-bar--good" height="100%" width-percent={player.attributes[3].value} width={player.attributes[3].value + "%"}></rect>
      						</svg>
    					</div>
						<div className="ut-bio-stats_content">
							<table className="ut-bio-stats_data">
					...
					<div className="ut-bio-stats_item ut-grid-view_item">
    					<div class="ut-bio-stats_header">
      						...
      						<svg className="ut-bio-stats_graph">
        						<rect className="ut-bio-stats_graph-bar ut-bio-stats_graph-bar--good" height="100%" width-percent={player.attributes[1].value} width={player.attributes[1].value + "%"}></rect>
      						</svg>
    					</div>
						<div className="ut-bio-stats_content">
							<table className="ut-bio-stats_data">
